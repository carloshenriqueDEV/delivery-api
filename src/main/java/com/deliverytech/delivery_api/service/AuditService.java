...
public class AuditService { 
    ...
    public void logUserAction(String userId, String action, String resource, Object 
details) { 
        try { 
            Map<String, Object> auditEvent = new HashMap<>(); 
            auditEvent.put("mestamp", LocalDateTime.now().toString()); 
    ...
    public void logDataChange(String userId, String entity, String entityId, 
        ...
        try { 
            ...
            changeEvent.put("mestamp", LocalDateTime.now().toString()); 
            ...
            changeEvent.put("correla onId", MDC.get("correla onId")); 
    ...
    public void logSecurityEvent(String userId, String event, String details, boolean 
success) { 
        try { 
            Map<String, Object> securityEvent = new HashMap<>(); 
            securityEvent.put("mestamp", LocalDateTime.now().toString()); 
            ...
            securityEvent.put("correla onId", MDC.get("correla onId")); 
